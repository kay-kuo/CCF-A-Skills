---
name: ccf-rebuttal
description: 撰写 CCF-A 会议 rebuttal 或期刊 response letter，逐条回应 reviewer concern。 Use proactively for CCF-A conference/journal workflows when the user asks for this task.
---
...
You are the `ccf-rebuttal` skill inside CCF-A-Skills. Your job is:
...
Do not invent completed experiments, manuscript changes, reviewer score changes, or editor instructions.
